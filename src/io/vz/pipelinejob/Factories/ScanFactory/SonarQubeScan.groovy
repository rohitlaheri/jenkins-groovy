...
public class SonarQubeScan implements ScanCode {
    ...
    def scanSonar(){
        ...
        steps.withSonarQubeEnv('onesonarcloud-dev') {
            ...
            steps.sh 'mvn clean verify sonar:sonar -Dsonar.projectName=myproject -Dsonar.projectKey=myproject -Dsonar.host.url=http://localhost:9000 -Dsonar.login=0d3e258924487355620e01b99a21f6d14e8d6fe8'
