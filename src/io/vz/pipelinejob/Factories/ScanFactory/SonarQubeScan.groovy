...
public class SonarQubeScan implements ScanCode {
    ...
    def scanSonar(){
        ...
        steps.withSonarQubeEnv('onesonarcloud-dev') {
            ...
            steps.sh 'mvn clean verify sonar:sonar -e -X -Dsonar.projectName=myproject -Dsonar.projectKey=myproject -Dsonar.host.url=https://657e-96-75-181-10.ngrok.io -Dsonar.login=0d3e258924487355620e01b99a21f6d14e8d6fe8 -Dsonar.forceAuthentication=true'
